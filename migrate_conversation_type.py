...
def migrate_database():
    ...
    try:
        ...
        cursor.execute("ALTER TABLE conversations ADD COLUMN conversation_type TEXT DEFAULT 'chat'")
        
        # Обновляем существующие записи
        cursor.execute("UPDATE conversations SET conversation_type = 'chat' WHERE conversation_type IS NULL")
