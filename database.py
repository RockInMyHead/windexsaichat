...
# Ensure the DB path is absolute, based on this file's directory
BASE_DIR = os.path.dirname(os.path.realpath(__file__))
DATABASE_URL = os.getenv(
    "DATABASE_URL",
    f"sqlite:///{os.path.join(BASE_DIR, 'windexai.db')}"
)
...
class User(Base):
    ...
    # Subscription fields
    subscription_plan = Column(String, default="free")  # 'free' or 'pro'
