...
from database import get_db, Conversation as DBConversation, Message as DBMessage, Document as DBDocument
...
async def get_user_documents(
    ...
    ).order_by(DBDocument.upload_date.desc()).all()
...
async def get_document(
    ...
    return DocumentInfo(
        ...
        content_preview=document.content[:500] + "..." if document.content and len(document.content) > 500 else document.content or ""
    )
