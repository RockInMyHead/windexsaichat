...
def migrate_database():
    ...
    try:
        ...
        old_cursor.execute("SELECT id, title, created_at, updated_at, user_id FROM conversations")
        ...
        old_cursor.execute("SELECT id, role, content, timestamp, conversation_id FROM messages")
        ...
        old_cursor.execute("SELECT id, title, description, deploy_url, html_content, css_content, js_content, is_active, created_at, updated_at, user_id FROM deployments")
